...
import com.kapibarabanka.ao3scrapper.domain.{ArchiveWarning, Category, Character, Fandom, FreeformTag, Published, PublishedAndUpdated, Rating, Relationship, RelationshipType, Series, Work}
